...
for n_points in range(1,total_n_points+1):  
    ...
    contour1 = axes[0, 0].contourf(X, Y, levels=100, cmap="viridis", vmin=vmin, vmax=vmax)
    axes[0, 0].set_title("Ground Truth Free Energy")
    
    # Second plot: Predicted BQ
    contour2 = axes[0, 1].contourf(X, Y,  levels=100, cmap="viridis", vmin=vmin, vmax=vmax)
