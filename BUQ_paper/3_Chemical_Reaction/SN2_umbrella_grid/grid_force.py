...
# Build design points on the same 10x10 grid as the force data
D1, D2 = np.meshgrid(d1_vals, d2_vals, indexing='ij')  # shape (10, 10) each
X_data = np.column_stack((D2.ravel(), D1.ravel()))     # shape (100, 2)

force_data = np.column_stack((der_d2, der_d1))         # shape (100, 2)
